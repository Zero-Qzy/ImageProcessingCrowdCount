...
model_path = './saved_models/mcnn_shtech_110.h5'
...
for blob in data_loader:                        
    ...
    # imgcount = cv2.imread('./output/density_maps_mcnn_shtechA_660/'+'output_' + blob['fname'].split('.')[0] + '.png')
    # height = imgcount.shape[0]
    # width = imgcount.shape[1]     
    # count = 0
